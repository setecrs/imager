          ...
          .then(() => {
            function updateStatus () {
              ...
              .then((size) => {
                ...
                let percent = (size / (material.properties.SIZE * 512)) * 100
